...
const Articles = () => {
  return (
    ...
    <div id='articles' className="py-5 px-20 flex justify-center gap-3 flex-wrap">
      {
        articles.map(article=>{
          return(
              <div className="bg-gray-100 dark:bg-gray-900 p-2 lg:w-1/4 w-[80%] md:w-1/3 leading-7 " >
